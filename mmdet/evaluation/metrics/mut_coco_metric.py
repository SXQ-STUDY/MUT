...
from mmengine.fileio import dump, get_local_path, load, list_from_file
...
class MUT_CocoMetric(BaseMetric):
    ...
    def __init__(self,
        ...
        # voc_imgid 2 coco_imgid
        img_names_list = list_from_file(img_txt_path)
        self.coco_img_ids = {name: i for i,name in enumerate(img_names_list)}
    ...
    def process(self, data_batch: dict, data_samples: Sequence[dict]) -> None:
        ...
        for data_sample in data_samples:
            ...
            result['img_id'] = self.coco_img_ids[data_sample['img_id']]
            ...
            gt['img_id'] = self.coco_img_ids[data_sample['img_id']]
