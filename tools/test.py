...
def main():
    ...
    args.config = r'myconfigs\debug_config\yolov8_s_syncbn_fast_8xb16-500e_bdd100k_sub.py'
    # args.config = r'myconfigs\debug_config\yolov8_s_syncbn_fast_8xb16-500e_coco.py'
    # args.config = r'myconfigs\yolov8_s_syncbn_fast_8xb16-500e_voc.py'
    args.checkpoint = r'yolov8_s_syncbn_fast_8xb16-500e_coco_20230117_180101-5aa5f0f1.pth'
