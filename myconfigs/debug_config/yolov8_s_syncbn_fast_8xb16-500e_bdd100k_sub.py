...
# -----data related-----
data_root = r'bdd100k_mut_sub'  # Root path of data
...
val_evaluator = [
    ...
    dict(
        ...
        ann_file = r'D:\BaiduSyncdisk\code\mut\bdd100k_mut_sub_coco\bdd100k_mut_coco_val.json', 
        img_txt_path = r'D:\BaiduSyncdisk\code\mut\bdd100k_mut_sub\train_val_txt\val.txt',
        proposal_nums=(100, 1, 10), 
        metric='bbox'
    ),
